...
//    final path = join(documentsDirectory.path, 'clean_business.db');
    ...
    return await openDatabase(path, version: 1, onOpen: (db) {},
      ...
      await db.execute("CREATE TABLE $TABLE_ORDER("
          ...
          " $START_TIME REAL,"
          " $END_TIME REAL,"
          " $EVALUATE_SPEED INTEGER DEFAULT 0,"
          " $EVALUATE_QUALITY INTEGER DEFAULT 0,"
          " $EVALUATE_CONFIG INTEGER DEFAULT 0,"
          " $EVALUATE_MAINTAIN INTEGER DEFAULT 0,"
          " $EVALUATE_SERVER INTEGER DEFAULT 0"
          ");");
